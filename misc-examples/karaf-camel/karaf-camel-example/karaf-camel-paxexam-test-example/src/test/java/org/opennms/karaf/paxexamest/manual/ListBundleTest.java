...
public class ListBundleTest extends TestBase {
	private static Logger LOG = LoggerFactory.getLogger(ListBundleTest.class);
	
	@Test
	public void testBundleList() throws Exception{
